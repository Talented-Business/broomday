		...
		wc_register_order_type(
			...
			apply_filters( 'woocommerce_register_post_type_subscription',
				array(
					...
					'labels'              => array(
						'name'               => __( 'Suscripciones', 'woocommerce-subscriptions' ),
						'singular_name'      => __( 'Suscripción', 'woocommerce-subscriptions' ),
						'add_new'            => _x( 'Añadir suscripción', 'custom post type setting', 'woocommerce-subscriptions' ),
						'add_new_item'       => _x( '
Añadir una nueva suscripción', 'custom post type setting', 'woocommerce-subscriptions' ),
						'edit'               => _x( 'Editar', 'custom post type setting', 'woocommerce-subscriptions' ),
						'edit_item'          => _x( '
Editar suscripción', 'custom post type setting', 'woocommerce-subscriptions' ),
						'new_item'           => _x( 'Nueva suscripcion', 'custom post type setting', 'woocommerce-subscriptions' ),
						'view'               => _x( '
Ver Suscripción', 'custom post type setting', 'woocommerce-subscriptions' ),
						'view_item'          => _x( '
Ver Suscripción', 'custom post type setting', 'woocommerce-subscriptions' ),
						'search_items'       => __( '
Buscar suscripciones', 'woocommerce-subscriptions' ),
						'not_found'          => self::get_not_found_text(),
						'not_found_in_trash' => _x( '
No se encontraron suscripciones en la basura', 'custom post type setting', 'woocommerce-subscriptions' ),
						'parent'             => _x( 'Suscripciones de padres', 'custom post type setting', 'woocommerce-subscriptions' ),
						'menu_name'          => __( 'Suscripciones', 'woocommerce-subscriptions' ),
					),
					'description'         => __( '
Aquí es donde se almacenan las suscripciones.', 'woocommerce-subscriptions' ),
					'public'              => false,
					'show_ui'             => true,
	...
	private static function get_not_found_text() {
		...
		if ( true === apply_filters( 'woocommerce_subscriptions_not_empty', $subscriptions_exist ) ) {
			$not_found_text = __( 'No se encontraron suscripciones', 'woocommerce-subscriptions' );
		} else {
			$not_found_text = '<p>' . __( '
Las suscripciones aparecerán aquí para que las vea y administre una vez compradas por un cliente.', 'woocommerce-subscriptions' ) . '</p>';
			// translators: placeholders are opening and closing link tags
			$not_found_text .= '<p>' . sprintf( __( '%s
Obtenga más información sobre la gestión de suscripciones &raquo;%s', 'woocommerce-subscriptions' ), '<a href="http://docs.woocommerce.com/document/subscriptions/store-manager-guide/#section-3" target="_blank">', '</a>' ) . '</p>';
			// translators: placeholders are opening and closing link tags
			$not_found_text .= '<p>' . sprintf( __( '%s
Añadir un producto de suscripción &raquo;%s', 'woocommerce-subscriptions' ), '<a href="' . esc_url( WC_Subscriptions_Admin::add_subscription_url() ) . '">', '</a>' ) . '</p>';
		}
