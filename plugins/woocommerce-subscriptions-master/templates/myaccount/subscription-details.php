...
<table class="shop_table subscription_details">
	...
	//echo $date;die; ?>
	<tr>
		<td><?php echo esc_html_x( 'Siguiente fecha de cobro', 'table heading',  'woocommerce-subscriptions' ); ?></td>
		<td><?php echo date("Y-m-d h:i a", strtotime($next_payment.' +5')); ?></td>
	</tr>
	<?php foreach ( array(
...
Fecha / hora de la próxima limpieza', 'admin subscription table header', 'woocommerce-subscriptions' ),
		...
		<?php $newDate = date("Y-m-d h:i a", strtotime($date.' +5'));?>
		<?php if ( ! empty( $date ) ) : ?>
			<tr>
