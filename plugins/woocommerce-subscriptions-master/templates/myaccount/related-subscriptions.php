...
<header>
	<h2><?php esc_html_e( '
Suscripciones relacionadas', 'woocommerce-subscriptions' ); ?></h2>
</header>
<table class="shop_table shop_table_responsive my_account_orders">
	<thead>
		<tr>
			<th class="order-number"><span class="nobr"><?php esc_html_e( 'Suscripción', 'woocommerce-subscriptions' ); ?></span></th>
			<th class="order-date"><span class="nobr"><?php esc_html_e( 'Estado', 'woocommerce-subscriptions' ); ?></span></th>
			<th class="order-status"><span class="nobr"><?php echo esc_html_x( '
Siguiente pago', 'table heading', 'woocommerce-subscriptions' ); ?></span></th>
			<th class="order-total"><span class="nobr"><?php echo esc_html_x( 'Total', 'table heading', 'woocommerce-subscriptions' ); ?></span></th>
			<th class="order-booking"><span class="nobr"><?php echo esc_html_x( 'Fecha / hora de la próxima reserva', 'table heading', 'woocommerce-subscriptions' ); ?></span></th>
		...
		<?php foreach ( $subscriptions as $subscription_id => $subscription ) : ?>
			...
			<tr class="order">
				...
				<td class="order-booking" data-title="<?php echo esc_attr_x( 'Next Booking Date/Time', 'Used in data attribute. Escaped', 'woocommerce-subscriptions' ); ?>">
					...
					$date_type="schedule_next_payment"; echo spanish_date(date('F j, Y', strtotime($date)));
					?>
				</td>
