...
function wcs_get_subscription_statuses() {
	...
	$subscription_statuses = array(
		...
		'wc-active'         => _x( 'Activo', 'Subscription status', 'woocommerce-subscriptions' ),
		'wc-on-hold'        => _x( 'En espera', 'Subscription status', 'woocommerce-subscriptions' ),
		'wc-cancelled'      => _x( 'Cancelado', 'Subscription status', 'woocommerce-subscriptions' ),
		'wc-switched'       => _x( 'Conmutado', 'Subscription status', 'woocommerce-subscriptions' ),
		'wc-expired'        => _x( 'Expired', 'Subscription status', 'woocommerce-subscriptions' ),
		'wc-pending-cancel' => _x( 'Cancelación pendiente', 'Subscription status', 'woocommerce-subscriptions' ),
	);
