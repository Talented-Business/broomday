...
class WC_Subscriptions_Order {
	...
	public static function subscription_thank_you( $order_id ) {
		...
		if ( wcs_order_contains_subscription( $order_id, 'any' ) ) {
			...
			$thank_you_message            = '<p style="font-size:20px;">' . _n( 'Su suscripción será activado una vez el pago sea procesado.', 'Su suscripción será activado una vez el pago sea procesado.', $subscription_count, 'woocommerce-subscriptions' ) . '</p>';
			...
			$thank_you_message .= '<p style="font-size:20px;">' . sprintf( _n( 'Revise el status de tu suscripción en  %sMi Cuenta%s.', 'Revise el status de tu suscripción en  %sMi Cuenta%s.', $subscription_count, 'woocommerce-subscriptions' ), '<a href="' . $my_account_subscriptions_url . '">', '</a>' ) . '</p>';
