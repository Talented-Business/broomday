			...
			<table id="guests-table" class="display striped" cellspacing="0" width="100%" ><!--class="wp-list-table widefat fixed customers"-->
				<thead>
						<tr>
							...
							<th scope="col" class="manage-column column-address" style="display:none"><?php  _e('Address (billing)', 'woocommerce-customers-manager');?></th>
							<th scope="col" class="manage-column column-address" style="display:none"><?php  _e('Address (shipping)', 'woocommerce-customers-manager');?></th>
