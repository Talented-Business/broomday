			...
			jQuery.each(guest_customers, function( key, value_array )
				{
					...
					if(typeof value_array !== 'string')
					{
						...
						html_string += '<td style="display:none;"class="address column-address">'+value_array[13]+' '+value_array[14]+' '+value_array[17]+' '+value_array[19]+' '+value_array[21]+' '+value_array[22]+' '+value_array[23]+' '+value_array[24]+'</td>';
						html_string += '<td style="display:none;"  class="address column-address">'+value_array[25]+' '+value_array[26]+' '+value_array[27]+' '+value_array[28]+' '+value_array[30]+' '+value_array[31]+' '+value_array[32]+' '+value_array[33]+'</td>';
