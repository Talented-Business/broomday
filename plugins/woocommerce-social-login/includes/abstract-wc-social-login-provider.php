...
abstract class WC_Social_Login_Provider extends WC_Settings_API {
	...
	public function init_form_fields() {
		 ...
		 * @param string $provider_id Social Login provider identifier.
		 */
		$this->form_fields = apply_filters( 'wc_social_login_provider_default_form_fields', $this->get_form_fields(), $this->get_id() );
	}
