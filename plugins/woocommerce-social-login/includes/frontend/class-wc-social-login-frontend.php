...
class WC_Social_Login_Frontend {
	...
	public function __construct() {
		...
		add_action( 'woocommerce_login_form_start', array( $this, 'render_social_login_buttons' ) );
        add_action( 'woocommerce_register_form_start', array( $this, 'render_social_login_buttons' ),9 );
