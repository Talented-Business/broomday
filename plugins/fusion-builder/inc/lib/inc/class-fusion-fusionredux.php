...
class Fusion_FusionRedux {
	...
	public function create_field( $field, $section_id = null ) {
		...
		if ( isset( $soft_dependencies[ $field['id'] ] ) && 'custom' !== $field['type'] ) {
			...
			$correlation_link = '  <span class="fusion-hover-description"><a href="https://theme-fusion.com/avada-doc/options/how-options-work/" target="_blank" rel="noopener noreferrer">' . sprintf( __( 'This is a dependent option that always stays visible because other %s Options can utilize it.', 'fusion-builder' ), $option_type ) . '</a></span>';
