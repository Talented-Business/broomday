...
<h2 style="padding-left:20px!important"><?php esc_html_e( '
				...
				if ( apply_filters( 'woocommerce_order_item_visible', true, $item ) ) {
					...
					<tr class="<?php echo esc_attr( apply_filters( 'woocommerce_order_item_class', 'order_item', $item, $subscription ) ); ?>">
						...
						<td class="product-name">
							...
							$baths =  wc_get_order_item_meta($item_id , 'bathroom', true);
							$beds =  wc_get_order_item_meta($item_id , 'bedroom', true);
							echo "( Baños : $baths   ,   Habitaciones : $beds)";
							echo "<br>";
							$service_hour =  wc_get_order_item_meta($item_id , 'service_hour', true);
							echo "<strong>Horas Contratadas</strong> : $service_hour";
